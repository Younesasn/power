...
J'ai géré les messages d'erreurs & de succès via le paramètre ´´´php $_GET´´´ dans ma classe "Notifiaction", ce qui me forçait à déclarer de nombreux codes pour chaque situation différente, ce qui ne me plaisais pas vraiment. Le mieux aurait été de les gérer avec les ´´´php $_SESSION´´´ pour pouvoir être + "propre" dans la gestion de messages.
